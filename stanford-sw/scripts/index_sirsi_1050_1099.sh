...
# added uni_10500000_10999999.marc file to data dump
...
nohup java -Xmx1g -Xms256m -cp $CP -jar $SITE_JAR $RAW_DATA_DIR/uni_10500000_10999999.marc &>$LOG_DIR/log1050-1099.txt
#nohup java -Xmx1g -Xms256m -Dsolr.commit_at_end="true" -cp $CP -jar $SITE_JAR $RAW_DATA_DIR/uni_10500000_10999999.marc &>$LOG_DIR/log1050-1099.txt
