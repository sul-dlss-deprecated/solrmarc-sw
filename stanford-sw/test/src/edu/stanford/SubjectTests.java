...
@Test
      ...
      throws ParserConfigurationException, IOException, SAXException, SolrServerException
  {
      ...
      assertZeroResults(fldName, "\"be bee be\"");
      assertZeroResults(fldName, "\"keep me\"");
  }
...
@Test
      ...
      throws ParserConfigurationException, IOException, SAXException, SolrServerException
  {
    ...
    // topic = 600abcdq:600t:610ab:610t:630a:630t:650a

    // 600a, trailing period removed
    assertSingleResult("345228", fldName, "\"Zemnukhov, Ivan\"");
    assertZeroResults(fldName, "\"Zemnukhov, Ivan.\"");
    assertSingleResult("11552426", fldName, "\"'Abdu'l-Bahá\"");
    assertZeroResults(fldName, "\"'Abdu'l-Bahá.\"");
    ...
    assertSingleResult("1976918", fldName, "\"PRIN796\"");
    assertZeroResults(fldName, "\"%PRIN796\"");
    // 650a, redundant-occuring punctuation collapsed
    assertSingleResult("11623157", fldName, "\"(Das) Numinose\"");
    assertZeroResults(fldName, "\"((Das)) Numinose.\"");
    assertSingleResult("971078", fldName, "\"!Ko (African tribe)\"");
    assertZeroResults(fldName, "\"!!Ko (African tribe)\"");
    // 650a, missing opening or closing parenthesis removed
    assertSingleResult("9335854", fldName, "\"Numerical analysis\"");
    assertZeroResults(fldName, "\"(Numerical analysis.\"");
    assertSingleResult("9335854", fldName, "\"Ocean waves\"");
    assertZeroResults(fldName, "\"Ocean waves)\"");
    // 650a, starting asterisk removed
    assertSingleResult("11146347", fldName, "\"2x Devices-- Adiabatic Processes\"");
    assertSingleResult("11146347", fldName, "\"N70500* --Physics--Controlled Thermonuclear Research-- Kinetics (Theoretical)\"");
    assertZeroResults(fldName, "\"*2x Devices-- Adiabatic Processes.\"");
    ...
    docIds.add("1132");
    docIds.add("1133");
    assertResultSize(fldName, "\"Internet Resource\"", 0);
  }
