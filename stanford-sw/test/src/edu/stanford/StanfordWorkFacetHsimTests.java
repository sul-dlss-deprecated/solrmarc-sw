...
/**
 * tests for stanford_work_facet_hsim field, which includes Stanford
 * dissertatations and theses facet (hierarchical)
 * @author Shelley Doljack
 */
public class StanfordWorkFacetHsimTests extends AbstractStanfordTest
{
  private final String fldName = "stanford_work_facet_hsim";
...
@Before
  ...
  public void test502BA()
  {
    ...
    solrFldMapTest.assertSolrFldValue(record, fldName, "Thesis/Dissertation|Bachelor's|Bachelor of Arts (BA)");
    solrFldMapTest.assertSolrFldValue(record, otherFldName, "Department of Geophysics");
    solrFldMapTest.assertSolrFldHasNoValue(record, fldName, "Thesis/Dissertation|Bachelor's|Undergraduate honors thesis");
  }
  ...
  public void test502DMA()
  {
    ...
    solrFldMapTest.assertSolrFldValue(record, fldName, "Thesis/Dissertation|Doctoral|Doctor of Musical Arts (DMA)");
    solrFldMapTest.assertSolrFldValue(record, otherFldName, "Department of Music");
    solrFldMapTest.assertSolrFldHasNoValue(record, fldName, "Thesis/Dissertation|Master's|Master of Arts (MA)");
  }
  ...
  public void test502EdD()
  {
    ...
    solrFldMapTest.assertSolrFldValue(record, fldName, "Thesis/Dissertation|Doctoral|Doctor of Education (EdD)");
  ...
  public void test502EdM()
  {
    ...
    solrFldMapTest.assertSolrFldValue(record, fldName, "Thesis/Dissertation|Master's|Master of Education (EdM)");
  }
  ...
  public void test502EdS()
  {
    ...
    solrFldMapTest.assertSolrFldValue(record, fldName, "Thesis/Dissertation|Unspecified");
  }
  ...
  public void test502NotEdS()
  {
    ...
    solrFldMapTest.assertSolrFldValue(record, fldName, "Thesis/Dissertation|Doctoral|Doctor of Philosophy (PhD)");
    solrFldMapTest.assertSolrFldHasNoValue(record, fldName, "Thesis/Dissertation|Unspecified");
  }
  ...
  public void test502Engineering()
  {
    ...
    solrFldMapTest.assertSolrFldValue(record, fldName, "Thesis/Dissertation|Master's|Engineer");
  ...
  public void test502NotEngineer()
  {
    ...
    solrFldMapTest.assertSolrFldValue(record, fldName, "Thesis/Dissertation|Master's|Master of Arts (MA)");
    solrFldMapTest.assertSolrFldHasNoValue(record, fldName, "Thesis/Dissertation|Master's|Engineer");
  }
  ...
  public void test502JD()
  {
    ...
    solrFldMapTest.assertSolrFldValue(record, fldName, "Thesis/Dissertation|Doctoral|Doctor of Jurisprudence (JD)");
  }
  ...
  public void test502JSD()
  {
    ...
    solrFldMapTest.assertSolrFldValue(record, fldName, "Thesis/Dissertation|Doctoral|Doctor of the Science of Law (JSD)");
  ...
  public void test502JSM()
  {
    ...
    solrFldMapTest.assertSolrFldValue(record, fldName, "Thesis/Dissertation|Master's|Master of the Science of Law (JSM)");
  }
  ...
  public void test502LLM()
  {
    ...
    solrFldMapTest.assertSolrFldValue(record, fldName, "Thesis/Dissertation|Master's|Master of Laws (LLM)");
  }
  ...
  public void test502MD()
  {
    ...
    solrFldMapTest.assertSolrFldValue(record, fldName, "Thesis/Dissertation|Doctoral|Doctor of Medicine (MD)");
  ...
  public void test502MFA()
  {
    ...
    solrFldMapTest.assertSolrFldValue(record, fldName, "Thesis/Dissertation|Master's|Master of Fine Arts (MFA)");
  ...
  public void test502MLA()
  {
    ...
    solrFldMapTest.assertSolrFldValue(record, fldName, "Thesis/Dissertation|Master's|Master of Liberal Arts (MLA)");
  ...
  public void test502MLS()
  {
    ...
    solrFldMapTest.assertSolrFldValue(record, fldName, "Thesis/Dissertation|Master's|Master of Legal Studies (MLS)");
  ...
  public void test502MS()
  {
    ...
    solrFldMapTest.assertSolrFldValue(record, fldName, "Thesis/Dissertation|Master's|Master of Science (MS)");
  ...
  public void test502StudentReport()
  {
    ...
    solrFldMapTest.assertSolrFldValue(record, fldName, "Other student work|Student report");
  ...
  public void test502ThesisGradSchoolBusiness()
  {
    ...
    solrFldMapTest.assertSolrFldValue(record, fldName, "Thesis/Dissertation|Doctoral|Unspecified");
  ...
  public void test502UgradHonorsThesis()
  {
    ...
    solrFldMapTest.assertSolrFldValue(record, fldName, "Thesis/Dissertation|Bachelor's|Undergraduate honors thesis");
    solrFldMapTest.assertSolrFldHasNoValue(record, fldName, "Thesis/Dissertation|Bachelor's|Bachelor of Arts (BA)");
  }
  ...
  public void test502UnspecifiedMasters()
  {
    ...
    solrFldMapTest.assertSolrFldValue(record, fldName, "Thesis/Dissertation|Master's|Unspecified");
    solrFldMapTest.assertSolrFldHasNumValues(record, fldName, 1);
  }
